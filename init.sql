...
INSERT INTO service (id_thumbnail, name, center_activites, description, practical_info, header_photo, cta) VALUES
...
(1, 16, 'Tracey Cain', '/assets/images/persons/9/image.jpg', 'Operations Manager', '', '2020-06-01', 'Ironically, Jack''s first job after graduating was as a field representative for CI. He went on to work for the Diocese of Rumbek in Sudan, USAID in Nairobi, then Pact in Zambia and Namibia. All these organizations also fight global poverty. He moved back to the United States to be the executive director at the YMCA in Geneva, New York, before returning to CI. Jack holds a bachelor’s degree in history from Marquette University and an MBA from the Thunderbird School of Global Management.');
...
(3, 'laura.thornton@children.association.org', '+49 809-569-489', '08:00', '12:00'),
(4, 'jack.maccanna@children.association.org', '+49 825-456-236', '09:00', '18:00'),
